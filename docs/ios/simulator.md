...
Each iOS simulator that's configured on an Apple device will have a unique _device identifier_ assigned to it. UITest will use this device identifier to start the intended iOS simulator.
