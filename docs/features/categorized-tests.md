...
For more information, see the [NUnit console guide](http://www.nunit.org/index.php?p=consoleCommandLine&r=2.6.4) on how to use _category expressions_ to include or exclude tests according to category combinations.
